...
export const project = [
    {
        title:'Veras kitchen',
        description:'Veras kitchen is a food delivery app that allows users to order food online and get it delivered to their doorstep. The app is built using React Native and Firebase.',
        image: {vpn},
        git:'https://github.com/yolocap/Vera-s-kitchen',
